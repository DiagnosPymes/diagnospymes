...
class PYMERegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "terms_conditions_acceptance": _("Acepto el tratamiento de los datos personales suministrados <p> de conformidad con la política de tratamiento establecida por la Universidad EAFIT"),
        }
